...
import ImaxTexnologiya from "./ImaxTexnologiya";

function MainImax() {
  const [gun, setGun] = useState("Bu Gün");
  const arr = ["Cedvel", "Texnologiya"];
  ...
  return (
    <div className="bg-black">
      <div className="containercss text-[#f4f4f4]  font-Helvetica">
        <h1 className="text-[60px] font-normal py-5 pl-5">IMAX</h1>
          ...
          <>
            <div className="w-full  p-5">
              ...
              <div className="w-full">
                {data
                  .filter((item) => item.form.includes("IMAX"))
                  .map((item, index) => {
                    return (
                      <div
                        key={nanoid()}
                      ...
                      >
                        ...
                        <div className="w-[836px] ml-3 flex relative py-1">
                          {item.add
                            .filter((i) => {
                              const filterCondition = i.format === "IMAX";
