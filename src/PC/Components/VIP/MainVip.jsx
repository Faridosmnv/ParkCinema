...
import AzalClubVİPHall from "./AzalClubVİPHall";

function MainVip() {
  const [gun, setGun] = useState("Bu Gün");
  const arr = ["Cedvel", "Azal Club VİP Hall"];
  ...
  return (
    <div className="bg-black">
      <div className="containercss text-[#f4f4f4]  font-Helvetica">
        <h1 className="text-[60px] font-normal py-5 pl-5">
          Azal Club VİP Hall
        </h1>
          ...
          <>
            <div className="w-full  p-5">
              ...
              <div className="w-full">
                {data
                  .filter((item) => item.form.includes("3D"))
                  .map((item, index) => {
                    return (
                      <div
                        key={nanoid()}
                      ...
                      >
                        ...
                        <div className="w-[836px] ml-3 flex relative py-1">
                          {item.add
                            .filter((i) => {
                              const filterCondition = i.format === "3D";
