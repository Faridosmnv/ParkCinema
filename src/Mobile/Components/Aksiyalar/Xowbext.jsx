  ...
  return (
    <div className='font-Helvetica'>
      <div className='bg-[#F4F4F4] pb-5'>
        ...
        <h2 className='text-black font-bold text-[28px] px-5 py-[15px] '>Xoşbəxt saatlar. Hər gün ENDİRİM!</h2>
        <p className='text-[#292929] px-5 py-2 text-[22px]'>Bütün filmlərə bileti endirimlə almaq şansını qaçırmayın!</p>
        <p className='text-[#292929] px-5 py-2 text-[22px]'>Bu tarif bayram və qeyri-iş günləri istisna olmaqla həftə içi hər gün saat 14:00-a kimi Park Cinema Park Bulvar, MetroPark, Flame Towers, Zagulba Mall və Aygun Mall-da aktivdir.</p>
      </div>
