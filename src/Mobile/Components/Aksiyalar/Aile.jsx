  ...
  return (
    <div>
      <div className='bg-[#F4F4F4] font-Helvetica'>
        ...
        <h2 className='text-black font-bold text-[28px] px-5 py-[15px] '>Ailə tarifi</h2>
        <p className='text-[#292929] px-5 py-5 text-[22px]'>“Park Cinema”da “Ailə Tarifi”</p>
        <p className='text-[#292929] px-5 py-5 text-[22px]'>Həftə ərzində şəbəkəmizin bütün kinoteatrlarında xüsusi “Ailə tarifi”ndən istifadə edə bilərsiniz!</p>
        <p className='text-[#292929] px-5 py-5 text-[22px]'>2D filmlərə bir nəfər üçün qiymət - 5 AZN;<br />3D filmlərə bir nəfər üçün qiymət - 5 AZN;</p>
        <p className='text-[#292929] px-5 py-5 text-[22px]'>IMAX 2D formatında filmlərə bir nəfər üçün qiymət - 7 AZN;<br /> IMAX 3D formatında filmlərə bir nəfər üçün qiymət - 7 AZN. </p>
        <p className='text-[#292929] px-5 pb-5 text-[22px]'>Tarif 3 və 4 nəfərlik ailələr üçün keçərlidir.</p>
      </div>
