  ...
  return (
    <div>
      <div className='bg-[#F4F4F4] font-Helvetica'>
        ...
        <h2 className='text-black font-bold text-[28px] px-5 py-[15px] '>IMAX 8 AZN</h2>
        <p className='text-[#292929] px-5 py-2 text-[22px]'>*Aksiya hər həftənin II günləri saat 8:00-dan 23:59-a qədər keçərlidir</p>
        <p className='text-[#292929] px-5 py-2 text-[22px]'>*Bu qiymət yalnız 2D filmlərə şamil olunur</p>
        <p className='text-[#292929] px-5 py-2 text-[22px] font-bold'>*IMAX eynəklərini kinoteatrın kassalarında 3 AZN qiymətinə əldə etmək olar.</p>
        <p className='text-[#292929] px-5 pb-5 text-[22px] font-bold'>*Aksiya bayram və qeyri-iş günlərinə şamil olunmur.</p>
