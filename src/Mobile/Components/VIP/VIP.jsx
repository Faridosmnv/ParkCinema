...
import VipCedvel from './VipCedvel';
...
function Imax() {
    ...
    const headers = ['Cədvəl', 'Azal Club VİP Hall '];
    return (
        <div className='bg-[#F4F4F4] font-Helvetica'>
            <h5 className='text-[#B8B8B8] underline text-[18px] px-[20px] py-[12px]'>Azal Club VİP Hall</h5>
            <h2 className='text-black font-bold text-[28px] px-5'>Azal Club VİP Hall</h2>
            <img className='p-5' src="vip.jpg" alt="" />
            ...
            {selectedHeader === 0 ? <VipCedvel/> : <VipClub />}
